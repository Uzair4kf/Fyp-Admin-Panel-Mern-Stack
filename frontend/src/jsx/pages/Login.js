...
function Login(props) {
  ...
  return (
    <div className="authincation d-flex flex-column flex-lg-row flex-column-fluid">
      <div className="login-aside d-flex  flex-column flex-row-auto text-center">
        <div className="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
          <div className="mb-4 pt-5 text-center">
            <svg
      ...
      <div className="flex-row-fluid d-flex flex-column justify-content-center position-relative container mx-auto overflow-hidden p-7">
            ...
            <div className="row no-gutters">
              <div className="col-xl-12 tab-content">
                <div id="sign-in" className="auth-form   form-validation">
                  {props.errorMessage && (
                    <div className="my-2 border border-red-900 bg-red-300 p-1 text-red-900">
                      {props.errorMessage}
                    </div>
                  )}
                  {props.successMessage && (
                    <div className="my-2 border border-green-900 bg-green-300 p-1 text-green-900">
                      {props.successMessage}
                    </div>
                  )}
